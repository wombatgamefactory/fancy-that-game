...
console.log(`  SINCE 12 AUGUST THERE ARE THREE, and no others:`);
console.log(`    'boardFull'   - a player's board is completely full. This is the game's clock and it`);
console.log(`                    is expected to end ESSENTIALLY EVERY GAME (~99%).`);
console.log(`    'standFull'   - a player's cake stand is completely full (all four rows, 10 tiles).`);
console.log(`                    New 12 August, and RARE: 0.4 / 0.8 / 1.2% of games at 2/3/4 players.`);
console.log(`                    Checked ahead of 'boardFull' so it wins the name when a turn arms`);
console.log(`                    both. A run showing many more than that is a run where claims got`);
console.log(`                    cheap - look at the claim step, not at the stand. See`);
console.log(`                    probe-standfull-ab-2026-08-12.js.`);
